...
category: skill
impact: CRITICAL
impactDescription: "Eliminates broken back stacks from push/go confusion, the #1 GoRouter bug reported in production Flutter apps"
tags: [gorouter, deep-linking, shell-route, routing, guards, redirect, typed-routes]
capabilities:
  ...
  - Push vs go navigation semantics
  - Redirect logic for auth flows
useWhen:
  - Setting up navigation in Flutter apps
  - Implementing GoRouter with authentication
  - Debugging broken back stack behavior
  - Adding deep linking with universal links
  - Creating persistent bottom nav with nested routes
---
