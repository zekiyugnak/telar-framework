...
category: skill
impact: HIGH
impactDescription: Establishes a single source of truth for design tokens across iOS and Android, eliminating visual inconsistencies and speeding up component development
tags: [design-system, design-tokens, figma, ios-hig, material-design, dark-mode, accessibility, theming]
capabilities:
  - Extract design tokens from Figma exports or existing codebase
  - Generate platform-adaptive token sets (iOS HIG + Material 3)
  - Map light/dark mode tokens with semantic naming
  - Validate contrast ratios and touch target compliance
  - Produce DESIGN.md as the canonical design reference
useWhen:
  - Starting a new mobile app and need a design system
  - Translating Figma designs into code-ready tokens
  - Unifying inconsistent colors/typography across an existing app
  - Adding dark mode support systematically
  - Auditing accessibility of existing design tokens
---
