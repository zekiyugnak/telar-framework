...
category: skill
impact: HIGH
impactDescription: "Adversarial gate that catches silent-always-pass E2E anti-patterns (missing awaits, swallowed errors, fixed sleeps, unmocked writes, service_role-in-act) before a green suite gives false confidence"
tags: [testing, e2e, review, quality-gate, web]
capabilities:
  - 24 silent-pass anti-patterns in P0/P1/P2 tiers
  - Failure classification into root-cause categories
  - Enforces await-on-expect, no fixed sleeps, Arrange/Act separation
useWhen:
  - Reviewing a new or changed E2E spec before merge
  - A suite is green but suspiciously never catches regressions
---
