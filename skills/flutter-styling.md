...
id: flutter-styling
category: skill
tags: [theming, material3, cupertino, responsive, design-system, google-fonts, typography]
capabilities:
  - Material 3 theming
  - Cupertino styling for iOS
  - Custom theme creation
  - Responsive layouts
useWhen:
  - Implementing design systems in Flutter
  - Creating Material 3 themes
