---
id: web-component-scaffolding
category: skill
impact: HIGH
impactDescription: Eliminates boilerplate by generating fully typed, accessible, token-styled, tested React/TSX component packages from a spec in seconds, with consistent structure across the codebase
tags: [components, scaffolding, web, react, tsx, shadcn, cva, tailwind, accessibility, testing, vitest]
capabilities:
  - Convert a component spec into a typed React/TSX component package
  - Generate a companion hook, Vitest + @testing-library test, and optional story
  - Apply cn() + class-variance-authority for deterministic variant styling
  - Enforce Tailwind semantic tokens, no inline styles, and forwardRef where needed
  - Generate correct a11y roles/labels and wire jest-axe into the test
useWhen:
  - Building a new web UI component from a design or route spec
  - Establishing component-package conventions for a Vite + React + TS project
  - Scaffolding a design-system or feature component library
  - Need consistent, tested, accessible component file structure across the app
---
