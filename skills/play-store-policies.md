---
id: play-store-policies
category: skill
impact: HIGH
impactDescription: "Prevent app suspension and account termination by addressing top 20 policy violations proactively"
tags: [play-store, google-policies, data-safety, target-api, content-rating, billing, suspension]
capabilities:
  - Prevent top 20 Play Store rejection and suspension reasons
  - Complete Data Safety form accurately for all SDKs
  - Meet target API level requirements and migrate safely
  - Fill content rating questionnaire correctly
  - Comply with Google Play billing policies
useWhen:
  - Preparing an Android app for Play Store submission
  - App was rejected or suspended and needs policy fixes
  - Completing the Data Safety section for the first time
  - Upgrading target SDK version to meet Google's deadline
