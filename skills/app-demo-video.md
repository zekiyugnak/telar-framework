...
category: skill
impact: LOW
impactDescription: Automates screenshot and recording capture for app store listings, demo presentations, and documentation
tags: [screenshots, recording, demo, app-store, simulator, device-frames, presentation]
capabilities:
  - Automate simulator screenshot capture with xcrun simctl and adb
  - Record screen sessions from simulator/emulator
  - Generate app store screenshots with device frames
  - Script demo flows for reproducible walkthroughs
  - Create structured demo flow documents
useWhen:
  - Preparing app store screenshots for submission
  - Creating a demo video or walkthrough for stakeholders
  - Generating documentation screenshots programmatically
  - Need reproducible demo flows for presentations
---
