---
id: blueprint-chat-feature
category: skill
impact: HIGH
impactDescription: Complete real-time chat feature with message list, input, typing indicators, and read receipts
tags: [blueprint, chat, realtime, messaging, websocket, supabase-realtime]
capabilities:
  ...
  - Supabase Realtime backend integration
useWhen:
  - Building a chat or messaging feature
  - Adding real-time communication to an app
  - Need Supabase Realtime integration patterns
  - Building a support chat or social messaging
---
