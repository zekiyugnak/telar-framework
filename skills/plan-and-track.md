...
category: skill
impact: HIGH
impactDescription: Bridges brainstorming to execution with atomic task decomposition, requirement traceability, and persistent progress tracking
tags: [planning, tracking, progress, tasks, decomposition, plan, project-management, requirements, traceability]
capabilities:
  - Decompose features into 2-5 minute atomic tasks
  - Reference F-x / UI-x requirements in every task
  - Produce PLAN.md with dependency graph
  - Produce PROGRESS.md with live task checklist
  - Support mid-project task amendments
  - Mark done tasks as rework when requirements change
  - Integration with iterative-build-loop baton system
useWhen:
  - After brainstorm-first produces RESEARCH.md
  - Starting implementation of any feature with more than 2 steps
  - Need to track progress across multiple sessions
  - A requirement changes and tasks need updating
---
