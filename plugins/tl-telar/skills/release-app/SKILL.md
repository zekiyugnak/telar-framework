...
source_type: "command"
source_file: "commands/release-app.md"
---

# release-app

Migrated from `commands/release-app.md`.
...
- In Codex, this skill is the replacement for the Claude slash command `/tl-telar:release-app`; invoke it as `$release-app` or through `@tl-telar`.
