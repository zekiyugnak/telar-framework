---
name: "web-prompt-to-screen"
description: "Converts screen/page descriptions and/or Figma designs into detailed, structured **web route specifications** for a Vite + React + TanStack (or Astro / Next.js) app. When REQUIREMENTS.md exists, always consult the Design"
source_type: "skill"
source_file: "skills/web-prompt-to-screen.md"
---

# web-prompt-to-screen

Migrated from `skills/web-prompt-to-screen.md`.
