...
description: "FlatList creates and destroys views as the user scrolls, which causes garbage collection pauses and layout thrashing on large lists. FlashList recycles existing views by swapping data, similar to Android's RecyclerView. "
source_type: "skill"
source_file: "skills/list-optimization.md"
---

# list-optimization

Migrated from `skills/list-optimization.md`.
