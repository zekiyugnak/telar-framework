...
description: "Expert in making mobile apps accessible to all users, including those using assistive technologies."
source_type: "agent"
source_file: "agents/mobile-accessibility-expert.md"
---

# mobile-accessibility-expert

Migrated from `agents/mobile-accessibility-expert.md`.
