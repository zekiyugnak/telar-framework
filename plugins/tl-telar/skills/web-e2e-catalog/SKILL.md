---
name: "web-e2e-catalog"
description: "The most common failure mode for an E2E suite that starts small and grows is that it never gets a map: nobody can tell what's covered without reading every spec file, there's no way to run just the fast subset before a m"
source_type: "skill"
source_file: "skills/web-e2e-catalog.md"
---

# web-e2e-catalog

Migrated from `skills/web-e2e-catalog.md`.
