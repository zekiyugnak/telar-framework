...
description: "Expert in API integration patterns for React Native and Flutter applications."
source_type: "agent"
source_file: "agents/mobile-api-integration.md"
---

# mobile-api-integration

Migrated from `agents/mobile-api-integration.md`.
