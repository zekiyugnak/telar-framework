---
name: "supabase-tus-resumable-upload"
description: "Supabase Storage exposes a TUS-compatible endpoint alongside its plain REST upload API. TUS (the open resumable-upload protocol) splits a file into chunks, tracks how much of the file the server has already received, and"
source_type: "skill"
source_file: "skills/supabase-tus-resumable-upload.md"
---

# supabase-tus-resumable-upload

Migrated from `skills/supabase-tus-resumable-upload.md`.
