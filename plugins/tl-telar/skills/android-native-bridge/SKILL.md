---
name: "android-native-bridge"
description: "Expert in bridging native Android code (Kotlin/Java) with React Native and Flutter applications."
source_type: "agent"
source_file: "agents/android-native-bridge.md"
---

# android-native-bridge

Migrated from `agents/android-native-bridge.md`.
