---
name: "supabase-rls-client-patterns"
description: "This admin panel ships exclusively with the Supabase **anon key** — there is no server-side proxy, no edge function acting as a trusted intermediary for ordinary CRUD, and the `service_role` key must never exist in any f"
source_type: "skill"
source_file: "skills/supabase-rls-client-patterns.md"
---

# supabase-rls-client-patterns

Migrated from `skills/supabase-rls-client-patterns.md`.
