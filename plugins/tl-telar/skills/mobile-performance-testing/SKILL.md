...
description: "Expert in performance testing, profiling, and optimization for mobile applications."
source_type: "agent"
source_file: "agents/mobile-performance-testing.md"
---

# mobile-performance-testing

Migrated from `agents/mobile-performance-testing.md`.
