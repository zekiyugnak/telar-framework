---
name: "rust-testing-pyramid"
description: "The most common testing mistake in a Rust axum/sqlx service is inverting the pyramid: either everything is an integration test that spins up a full server and a shared database (slow, flaky, hard to run in parallel), or "
source_type: "skill"
source_file: "skills/rust-testing-pyramid.md"
---

# rust-testing-pyramid

Migrated from `skills/rust-testing-pyramid.md`.
