---
name: "rust-axum-routing"
description: "axum routes fall apart at scale in a predictable way: auth checks get copy-pasted into every handler, error responses drift into inconsistent shapes across endpoints, and cross-cutting concerns (CORS, logging, rate limit"
source_type: "skill"
source_file: "skills/rust-axum-routing.md"
---

# rust-axum-routing

Migrated from `skills/rust-axum-routing.md`.
