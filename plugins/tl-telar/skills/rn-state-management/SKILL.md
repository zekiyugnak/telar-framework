...
description: "Prop drilling through 5+ component levels causes entire subtrees to re-render when any piece of state changes. In React Native, this directly causes dropped frames during scrolling because the JS thread is blocked re-ren"
source_type: "skill"
source_file: "skills/rn-state-management.md"
---

# rn-state-management

Migrated from `skills/rn-state-management.md`.
