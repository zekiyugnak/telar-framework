...
description: "Expert in state management patterns and libraries for React Native and Flutter applications."
source_type: "agent"
source_file: "agents/mobile-state-management.md"
---

# mobile-state-management

Migrated from `agents/mobile-state-management.md`.
