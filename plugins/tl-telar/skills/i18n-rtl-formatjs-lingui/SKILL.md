---
name: "i18n-rtl-formatjs-lingui"
description: "This admin panel ships in Turkish and English today, with an explicit requirement to be RTL-ready for a future locale (Arabic, Hebrew, etc.) without a structural rewrite. That means every string goes through an i18n libr"
source_type: "skill"
source_file: "skills/i18n-rtl-formatjs-lingui.md"
---

# i18n-rtl-formatjs-lingui

Migrated from `skills/i18n-rtl-formatjs-lingui.md`.
