---
name: "clean-code"
description: "The defects that compound fastest are not crashes — they are **duplication**, **bloat**, and the **wrong abstraction**. Copy-pasted logic drifts out of sync; speculative flexibility slows every future change; and — the s"
source_type: "skill"
source_file: "skills/clean-code.md"
---

# clean-code

Migrated from `skills/clean-code.md`.
