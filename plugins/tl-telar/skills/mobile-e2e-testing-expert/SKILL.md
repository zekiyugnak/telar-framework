---
name: "mobile-e2e-testing-expert"
description: "Expert in end-to-end testing for React Native and Flutter mobile applications."
source_type: "agent"
source_file: "agents/mobile-e2e-testing-expert.md"
---

# mobile-e2e-testing-expert

Migrated from `agents/mobile-e2e-testing-expert.md`.
