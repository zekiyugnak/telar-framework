---
name: "web-design-system-architect"
description: "Owns the web design system for a Tailwind v4 (`@tailwindcss/vite`) + shadcn/Radix codebase: the `@theme` token layer wired to CSS custom properties, light/dark scheme swaps, shadcn theming, and — critically — a **single "
source_type: "agent"
source_file: "agents/web-design-system-architect.md"
---

# web-design-system-architect

Migrated from `agents/web-design-system-architect.md`.
