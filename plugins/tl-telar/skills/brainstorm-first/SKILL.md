...
description: "Enforces a structured technical discovery phase before implementation. Reads `REQUIREMENTS.md` (produced by `requirements-gather`) as input and produces `RESEARCH.md` — the technical architecture decisions document."
source_type: "skill"
source_file: "skills/brainstorm-first.md"
---

# brainstorm-first

Migrated from `skills/brainstorm-first.md`.
