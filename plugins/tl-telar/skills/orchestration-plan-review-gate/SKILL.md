---
name: "orchestration-plan-review-gate"
description: "This gate has **two interchangeable execution paths that MUST emit the identical aggregated verdict object** (Step 3). The prose path below is the canonical fallback and the single source of truth for reviewer prompts an"
source_type: "orchestration"
source_file: "skills/orchestration/plan-review-gate/SKILL.md"
---

# orchestration-plan-review-gate

Migrated from `skills/orchestration/plan-review-gate/SKILL.md`.
