...
description: "Expert in authentication patterns and implementation for mobile applications."
source_type: "agent"
source_file: "agents/mobile-auth-specialist.md"
---

# mobile-auth-specialist

Migrated from `agents/mobile-auth-specialist.md`.
