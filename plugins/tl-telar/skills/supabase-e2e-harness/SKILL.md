---
name: "supabase-e2e-harness"
description: "The most common mistake in Supabase E2E suites is letting `service_role` do double duty: it provisions the fixtures AND performs the action under test, which means the test never actually proves RLS works — it just prove"
source_type: "skill"
source_file: "skills/supabase-e2e-harness.md"
---

# supabase-e2e-harness

Migrated from `skills/supabase-e2e-harness.md`.
