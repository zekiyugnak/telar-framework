...
description: "Expert in mobile app release management, versioning, and deployment strategies."
source_type: "agent"
source_file: "agents/mobile-release-manager.md"
---

# mobile-release-manager

Migrated from `agents/mobile-release-manager.md`.
