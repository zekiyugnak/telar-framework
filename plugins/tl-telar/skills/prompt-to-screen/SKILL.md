---
name: "prompt-to-screen"
description: "Converts screen descriptions and/or Figma designs into detailed, structured screen specifications. When REQUIREMENTS.md exists, always consult the Design Assets table first to determine which mode to use."
source_type: "skill"
source_file: "skills/prompt-to-screen.md"
---

# prompt-to-screen

Migrated from `skills/prompt-to-screen.md`.
