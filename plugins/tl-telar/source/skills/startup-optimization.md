...
category: skill
impact: HIGH
impactDescription: "Reduces cold start from 4+ seconds to under 1.5 seconds; each second of startup loses 10% of users"
tags: [startup-time, cold-start, hermes, tree-shaking, lazy-loading, splash-screen, bundle]
capabilities:
  - Profile and measure cold start time before and after optimization
  - Optimize Hermes bytecode bundle size and startup
  - Implement tree shaking and dead code elimination
  - Lazy load screens and heavy modules on demand
  - Bridge splash screen to app ready state without white flash
useWhen:
  - App cold start exceeds 2 seconds
  - Bundle size is growing and affecting startup
  - Users report slow launch or white screen flash
  - Profiling reveals eager imports of heavy libraries
  - Optimizing time-to-interactive for mobile apps
---
