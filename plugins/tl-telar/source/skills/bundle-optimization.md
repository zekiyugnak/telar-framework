...
category: skill
impact: HIGH
impactDescription: "Reduce bundle size 40-70%, cutting download time and avoiding app store size warnings"
tags: [bundle-size, code-splitting, tree-shaking, lazy-loading, metro, assets]
capabilities:
  - Configure Metro bundler for tree shaking and code splitting
  - Implement lazy loading with React.lazy and dynamic imports
  - Analyze bundle contents with react-native-bundle-visualizer
  - Optimize image assets with WebP and SVG
  - Identify and remove unused dependencies
useWhen:
  - App bundle exceeds 15MB and triggers store warnings
  - Download/install times are unacceptably slow
  - Users on slow networks abandon installs
  - App store listing shows size complaints in reviews
---
