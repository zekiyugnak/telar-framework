---
id: flutter-device-plugins
category: skill
tags: [image-picker, camera, gallery, media, permissions, file-picker, share-plus]
capabilities:
  - image_picker for camera and gallery capture
  - Platform permission wiring (iOS Info.plist, Android manifest)
  - Image size and quality control to avoid OOM
  - Pairing with image_cropper for edit flows
  - file_picker for non-image documents
  - share_plus for sharing content out of the app
useWhen:
  - Adding photo capture or gallery selection to a Flutter app
  - Debugging missing iOS usage-description crashes
  - Handling Android 13+ photo-picker permission changes
  - Cropping or compressing user-selected images
  - Sharing files or text to other apps
---
