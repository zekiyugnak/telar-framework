---
id: blueprint-onboarding-flow
category: skill
impact: MEDIUM
impactDescription: Complete multi-step onboarding with pagination, skip, permission requests, and completion tracking
tags: [blueprint, onboarding, intro, welcome, permissions, first-launch]
capabilities:
  - Multi-step onboarding with swipeable pages
  - Skip functionality with completion tracking
  - Permission request integration (notifications, camera, location)
  - Animated illustrations with reduced motion support
  - Persistent completion state
useWhen:
  - Building first-launch onboarding
  - Adding permission request flow
  - Need a multi-step introduction wizard
  - Building a welcome/tutorial experience
---
