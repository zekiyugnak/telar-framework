---
id: blueprint-auth-flow
category: skill
impact: HIGH
impactDescription: Complete auth flow blueprint with login, signup, forgot password, and social auth for both RN and Flutter
tags: [blueprint, auth, login, signup, social-auth, forgot-password, authentication]
capabilities:
  - Complete authentication flow with all screens
  - Social auth integration (Google, Apple, Facebook)
  - Supabase backend auth setup
  - Biometric auth support
  - Secure token storage
useWhen:
  - Building authentication from scratch
  - Adding social login to an existing app
  - Setting up Supabase auth for a mobile app
  - Need a complete auth flow reference
---
