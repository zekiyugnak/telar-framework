---
id: blueprint-crud-list
category: skill
impact: HIGH
impactDescription: Complete master-detail CRUD pattern with pull-to-refresh, pagination, swipe actions, and optimistic updates
tags: [blueprint, crud, list, master-detail, pagination, pull-to-refresh, swipe-actions]
capabilities:
  - Master-detail list with CRUD operations
  - Pull-to-refresh and infinite scroll pagination
  - Swipe actions (edit, delete, archive)
  - Optimistic updates with rollback
  - Empty states and error handling
useWhen:
  - Building any list-based feature with CRUD
  - Adding master-detail navigation pattern
  - Need pagination with pull-to-refresh
  - Building a data management screen
---
