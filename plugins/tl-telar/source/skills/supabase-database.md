...
category: skill
impact: CRITICAL
impactDescription: "Missing RLS policies expose all user data to any authenticated client, leading to full data breach"
tags: [supabase, postgresql, rls, realtime, optimistic-updates, pagination]
capabilities:
  - Implement Row Level Security policies for user, team, and public data
  - Build optimistic update patterns with automatic rollback
  - Set up real-time subscriptions with proper lifecycle cleanup
  - Write efficient paginated queries with selective column fetching
useWhen:
  - Setting up Supabase database tables for a mobile app
  - Implementing Row Level Security policies
  - Building real-time features with Supabase subscriptions
  - Optimizing database query performance for mobile
  - Implementing optimistic updates with server sync
---
