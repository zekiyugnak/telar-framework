---
id: ui-library-integration
category: skill
impact: MEDIUM
impactDescription: Guides library selection to avoid costly mid-project rewrites and enables seamless theme/token integration with chosen UI framework
tags: [ui-library, tamagui, gluestack, react-native-paper, rn-elements, material-3, cupertino, flutter-adaptive]
capabilities:
  - Decision tree for React Native UI library selection
  - Decision tree for Flutter UI library selection
  - Theme customization and design token integration per library
  - Migration patterns between UI libraries
  - Performance comparison and trade-off analysis
useWhen:
  - Choosing a UI component library for a new mobile project
  - Integrating design tokens with a third-party UI library
  - Migrating from one UI library to another
  - Customizing library themes to match brand guidelines
---
