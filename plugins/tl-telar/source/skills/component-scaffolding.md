...
category: skill
impact: HIGH
impactDescription: Eliminates boilerplate creation time by generating fully typed, accessible, tested component packages from design specs in seconds
tags: [components, scaffolding, react-native, flutter, accessibility, testing, storybook, typed-props]
capabilities:
  - Convert design specs into typed React Native or Flutter components
  - Auto-generate prop interfaces with sensible defaults
  - Create companion hook, test, and story files
  - Enforce no inline styles and proper memoization
  - Generate accessibility labels and roles automatically
useWhen:
  - Building a new UI component from a design spec
  - Establishing component architecture patterns for a project
  - Scaffolding a component library or design system implementation
  - Need consistent file structure across all components
---
