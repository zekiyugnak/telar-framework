---
id: flutter-firebase-setup
category: skill
tags: [firebase, firebase-core, flutterfire, app-check, flavors, configuration]
capabilities:
  - FlutterFire CLI project configuration
  - Firebase.initializeApp with generated options
  - Per-flavor Firebase project wiring (dev/staging/prod)
  - App Check debug and production providers
  - Platform config file placement (google-services.json, GoogleService-Info.plist)
  - Adding additional Firebase products to an initialized app
useWhen:
  - Adding Firebase to a Flutter app for the first time
  - Wiring multiple Firebase projects per flavor
  - Debugging Firebase.initializeApp failures
  - Enabling App Check to protect backend services
  - Onboarding a new Firebase product (Messaging, Crashlytics, Analytics) to an existing app
---
