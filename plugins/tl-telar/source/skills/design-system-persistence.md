---
id: design-system-persistence
category: skill
impact: HIGH
impactDescription: Hierarchical design token persistence with global MASTER.md and per-screen overrides mapped to HIG and Material Design 3
tags: [design-system, tokens, theming, colors, typography, spacing, hig, material-design]
capabilities:
  - Global design token definition in MASTER.md
  - Per-screen override pattern with precedence rules
  - Apple HIG and Material Design 3 token mapping
  - Dark mode token variants
  - Design-to-code token translation
useWhen:
  - Setting up a design system for a mobile app
  - Need consistent theming across screens
  - Translating Figma tokens to code
