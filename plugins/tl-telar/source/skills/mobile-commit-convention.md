---
id: mobile-commit-convention
category: skill
impact: MEDIUM
impactDescription: Standardizes commit messages for mobile projects with platform-specific scopes and breaking change rules
tags: [git, commit, convention, changelog, versioning, release]
capabilities:
  - Mobile-specific conventional commit format
  - Platform scopes for iOS, Android, RN, Flutter
  - Breaking change rules for native module updates
  - Co-authored-by pattern for AI-assisted commits
  - Changelog generation from commit history
useWhen:
  - Committing code in a mobile project
