...
category: skill
impact: HIGH
impactDescription: "Avoid 1-2 week rejection delays by addressing the top 20 rejection reasons before submission"
tags: [app-store, apple-review, guidelines, rejection, testflight, privacy-labels, iap]
capabilities:
  - Prevent top 20 App Store rejection reasons
  - Configure privacy nutrition labels correctly
  - Meet screenshot and metadata requirements
  - Handle In-App Purchase guideline compliance
  - Optimize TestFlight beta testing workflow
useWhen:
  - Preparing an iOS app for App Store submission
  - App was rejected and needs fixes for resubmission
  - Setting up privacy nutrition labels
  - Configuring In-App Purchases to comply with Apple guidelines
  - Planning a TestFlight beta distribution
---
