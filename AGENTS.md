...
- **51 agents** available
- **23** with decision frameworks
- **24** with anti-pattern guidance
...
| [okf-knowledge-curator](#okf-knowledge-curator) | Yes | Yes |
...
| [web-design-system-architect](#web-design-system-architect) | Yes | Yes |
...
| [web-screen-builder](#web-screen-builder) | Yes | Yes |
| [web-security-architect](#web-security-architect) | Yes | Yes |
| [web-ui-ux-specialist](#web-ui-ux-specialist) | Yes | Yes |
...
**File:** `agents/okf-knowledge-curator.md`
...
**File:** `agents/web-design-system-architect.md`
...
**File:** `agents/web-screen-builder.md`
...
**File:** `agents/web-ui-ux-specialist.md`
