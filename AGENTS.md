...
| [mobile-architect-adversarial](#mobile-architect-adversarial) | - | - |
...
**Capabilities:**
- Astro project architecture for static, server, and hybrid marketing sites
...
**File:** `agents/mobile-architect-adversarial.md`
...
**File:** `agents/mobile-knowledge-curator.md`
...
**File:** `agents/mobile-orchestrator.md`
